...
const BottomNavigate = () => {
  return (
    <footer className="fixed bottom-0 w-full flex items-center justify-center h-20">
      ...
      <div className=" bg-primary h-20 w-[147px] absolute left-0 rounded-tr-2xl flex justify-center gap-x-10 items-center z-10 text-white">
      ...
      <div className=" bg-primary h-16 w-[121px] absolute bottom-0 z-0"></div>
      <div className=" bg-primary h-20 w-[147px] absolute right-0 rounded-tl-2xl flex justify-center gap-x-10 items-center z-10 text-white">
        <Link href="" className="flex flex-col items-center">
